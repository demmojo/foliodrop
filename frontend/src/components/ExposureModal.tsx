...
export default function ExposureModal({ photo, isOpen, onClose }: ExposureModalProps) {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-center justify-center bg-[#808080] animate-in fade-in duration-300"
      role="dialog"
      aria-modal="true"
    ...
    >
      <div 
        ref={modalRef}
        className="w-full h-full flex flex-col bg-[#808080] text-white animate-in zoom-in-95 duration-300"
      >
        {/* Header - Pro Utility aesthetic */}
        <div className="flex-none flex flex-col sm:flex-row items-start sm:items-center justify-between px-4 sm:px-6 py-3 bg-[#606060] border-b border-[#505050] z-10 gap-3 sm:gap-0">
        ...
        <div className="flex-1 flex min-h-0 relative">
          ...
          <div className="w-72 bg-[#404040] flex flex-col border-l border-[#303030] shrink-0 overflow-y-auto z-10 shadow-2xl">
        ...
        {/* Pro Utility Footer */}
        <div className="flex-none px-4 sm:px-6 py-2 bg-[#606060] border-t border-[#505050] z-10 flex justify-between items-center overflow-x-auto surfacespace-nowrap hide-scrollbar">
